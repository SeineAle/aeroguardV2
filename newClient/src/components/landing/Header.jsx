...
const Header = () => {
    ...
    const navItems = [
        ...
        {link: 'Maintainance Logs', path: '/maintainanceLogs'},
    ];
            ...
            <nav className={`py-4 lg:px-14 px-4 ${isSticky ? "sticky top-0 left-0 right-0 border bg-white duration-300" : ""}`}>
                <div className='flex justify-between items-center text-base gap-8'>
                    ...
                    <Link to='/' className='text-2xl font-semibold flex items-center'>
                        ...
                        <span className='text-steelBlue'>AeroGuard</span>
                    </Link>
                    ...
                    <div className='space-x-12 hidden lg:flex items-center'>
                        ...
                        <button className='hidden lg:flex items-center text-steelBlue hover:text-silver font-bold' onClick={() => { console.log("hi"); localStorage.removeItem('authToken'); setIsLoggedIn(false); navigate("/")
}}>LogOut</button>
