...
import productImg01 from '../../assets/products/productimg01.avif';
...
<div className='px-4 lg:px-14 max-w-screen-2xl mx-auto my-8' id='product'>
    <div className='md:w-11/12 mx-auto flex flex-col md:flex-row justify-between items-center gap-12'>
        ...
        <div className='md:w-3/5 mx-auto'>
            ...
            <button className='px-7 py-2 bg-steelBlue text-black font-bold rounded hover:bg-silver transition-all duration-300 hover:-translate-y-4' onClick={() => navigate("/signin")}><span className='hover:tracking-wide'>Get Started</span></button>
